local dataset_path = "./datasets/EC30/";

{
  ...
  "train_data_path": dataset_path + "ec30_leftjoin_overfitting.json",
  "validation_data_path": dataset_path + "ec30_leftjoin_overfitting.json",
  "model": {
    "type": "spider",
