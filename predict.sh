allennlp predict trained_model/ $1 --predictor spider_discriminator --use-dataset-reader --cuda-device=-1 --silent --output-file beam_predictions.jsonlines --include-package models.semantic_parsing.spider_parser --include-package dataset_readers.spider --include-package predictors.discriminator_dataset_generator --weights-file trained_model/model.th -o "{\"dataset_reader\":{\"keep_if_unparsable\":true, \"dataset_path\": \"$1/database\", \"tables_file\":\"$1/tables.json\"}}"
